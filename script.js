...
var myText = document.getElementById("floatingTextarea");
var myText1 = document.getElementById("floatingTextarea1");
var myCount = document.getElementById("count");
var myCount1 = document.getElementById("count1");
var myMax = myText.getAttribute("maxlength");
var myMax1 = myText.getAttribute("maxlength");

myText.oninput = function () {
  myCount.innerHTML = myMax - this.value.length;
};

myText1.oninput = function () {
  myCount1.innerHTML = myMax1 - this.value.length;
};
